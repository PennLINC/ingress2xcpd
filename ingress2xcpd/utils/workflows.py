"""
Nipype Workflows for Ingress2XCPD
"""
...
from ingress2xcpd.utils.interfaces import (
    Conform,
    ConformDwi,
    ConvertWarpfield,
    ExtractB0s,
...
def create_single_subject_wf(subject_layout, skip_mni2009c_norm=False):
    ...
    from ingress2xcpd.utils.workflows import parse_layout
    ...
    wf_name = f"ingress2xcpd_single_subject_{subject_name}_wf"
...
def create_ingress2xcpd_wf(layouts, name="ingress2xcpd_wf", base_dir=os.getcwd()):
    """
    Creates the overall ingress2xcpd workflow.
    ...
    name : str, optional
        The name of the workflow. Default is "ingress2xcpd_wf".
