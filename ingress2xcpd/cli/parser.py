...
def _build_parser(**kwargs):
    ...
    parser = ArgumentParser(
        description=f"Ingress2XCPD: Restructuring Bespoke Data for Use in XCP_D",
    ...
    #    action="store_true",
    #    default=False,
    #    help="Skip MNI normalization step. MNI normalization is not required for all pipelines in XCP_D.",
    #)
    return parser
