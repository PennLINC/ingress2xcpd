...
def create_single_subject_wf(subject_layout):
    ...
    input_node = Node(IdentityInterface(fields=['subject_layout',"MNI2009cAsym_to_MNINLin6","MNINLin6_to_MNI2009cAsym"]), name='input_node')
    ...
    if (
        ...
        warp_files_list_MNI2subject = Node(Function(
            input_names=['file1', 'file2'],
            output_names=['combined_files'],
            function=combine_warp_files
        ), name='list_warp_files_MNI2subject')

        # Create a Function node to make a list of warp files for subject2MNI
        warp_files_list_subject2MNI = Node(Function(
            input_names=['file1', 'file2'],
            output_names=['combined_files'],
            function=combine_warp_files
